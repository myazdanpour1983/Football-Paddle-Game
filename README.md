...
The game uses the following Python packages:
...
The game automatically saves the highest score in a file named highscore.json.
...
If NumPy or the Pygame mixer is unavailable, the game can still run without the generated sound effects.
...
The highscore.json file may not exist when you first download or clone the project. It will be generated automatically after achieving a new high score.
...
It also uses the following Python standard library modules:
...
Created as a Python and Pygame game development project.
